...
<head>
    ...
    <!-- css링크 -->
    <!-- 내부css -->
    <link rel="stylesheet" href="resources/css/company/companyRoomRegisterForm.css" type="text/css">
    <!-- 외부 css -->
    ...
    <form id="placeForm" action="submit_place" method="post" enctype="multipart/form-data">
		...
		<div class="mb-3 d-flex align-items-center">
		    ...
		    <div class="input-container">
		        <input type="tel" id="phoneNumberMiddle" name="phoneNumberMiddle" class="form-control" placeholder=" 1234 -  5678 " />
		    </div>
